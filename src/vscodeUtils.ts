...
export async function jumpToUriAtPosition(uri: Uri, position: Position, preserveFocus: boolean) {
  ...
  if (!d) {
    ...
    e.revealRange(new Range(position, position), TextEditorRevealType.InCenter);
